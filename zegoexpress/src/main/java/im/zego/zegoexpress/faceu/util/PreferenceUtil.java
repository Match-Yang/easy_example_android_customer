package im.zego.zegoexpress.faceu.util;
...
public class PreferenceUtil {
    ...
    private PreferenceUtil() {
        mSharedPreferences = ExpressManager.getInstance().getApplication().getSharedPreferences(SHARE_PREFERENCE_NAME, AppCompatActivity.MODE_PRIVATE);
    }
